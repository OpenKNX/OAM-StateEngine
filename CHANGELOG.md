...
* Update OFM-**DFA** auf <b style="color:red;">TODO</b> (von 0.8.2; [Changes](https://github.com/OpenKNX/OFM-DFA/blob/v1/CHANGELOG.md))
  * Refactor: Parameter-Handling
* Update anderer OpenKNX-Module:
  * OGM-**Common** auf 1.8.0 (von 1.7.2; [Changes](https://github.com/OpenKNX/OGM-Common/blob/v1/CHANGELOG.md#180-2026-05-15))
    * Korrekturen in Zeitimplementierung
    * <b style="color:red;">TODO</b> Persistierung auch bei Neustart über Diagnose-Kommando
    * LED-Anzeige für unkonfigurierten Zustand
  * OFM-**LogicModule** auf 4.3 (von 4.0.1; [Änderungshistorie](https://github.com/OpenKNX/OFM-LogicModule/blob/v1/doc/Applikationsbeschreibung-Logik.md#%C3%A4nderungshistorie))
    * Neues Feature: Kanal-Sperre
    * Erweiterung: Option zur LED-Anzeige von Rückkopplungen
    * Fehlerkorrekturen
  * OGM-HardwareConfig auf Stand 2026-05-15
